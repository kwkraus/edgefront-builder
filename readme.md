...
- **Series & session management** — Create webinar series containing multiple sessions; edit titles inline without leaving the page; manage schedules, presenters, and coordinators.
