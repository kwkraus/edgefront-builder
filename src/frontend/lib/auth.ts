...
export const authOptions: AuthOptions = {
  providers: [
    AzureADProvider({
      ...
      authorization: {
        params: {
          scope: `openid profile email offline_access https://graph.microsoft.com/User.Read${process.env.AZURE_AD_CLIENT_ID ? ` api://${process.env.AZURE_AD_CLIENT_ID}/access_as_user` : ''}`,
        },
      },
    }),
  ],
